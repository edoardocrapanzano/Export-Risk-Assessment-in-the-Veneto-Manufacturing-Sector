...
* **Libraries/Packages:** tidyverse, readxl, WDI package, rnaturalearth, rnaturalearthdata, geosphere, igraph, ineq, fixest, lme4, lmerTest, quantreg, akima, broom, xgboost, rsample, ggplot2, scales, patchwork, plotly.
* **Methodologies:** PCA, Statistical and Econometric Models (LMMs and PPMLs), Machine Learning (XGBoost), Network Analysis, Institutional Risk Analysis.
...
## 🚀 How to run the code
The main analysis can be found in the `export_risk_assesment.R` file which can be executed with RStudio. [📄 Read the full Master Thesis(PDF)](./Master_Thesis.pdf)
